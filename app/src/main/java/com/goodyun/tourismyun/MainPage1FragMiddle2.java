...
public class MainPage1FragMiddle2 extends AppCompatActivity {


    ArrayList<MainPage1FragMiddlesItem> items = new ArrayList<>();
    MainPage1FragMiddle2Adapter adapter;
    RecyclerView recyclerView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.main_page1_frag_middle2);

        reedRSS();
        recyclerView = findViewById(R.id.m2_recycler);
        adapter = new MainPage1FragMiddle2Adapter(this,items);
